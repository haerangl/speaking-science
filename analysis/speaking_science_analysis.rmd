...
mod_2 <- lm(credibility ~ treatment, data=d)
mod_3 <- lm(importance ~ treatment, data=d)
...
stargazer(mod_1,mod_2,mod_3,mod_4,mod_5, 
          ...
          dep.var.labels = c("Questions Correct", "Credibility", "Importance", "Article Read Time (seconds)", "Donation in USD"),
