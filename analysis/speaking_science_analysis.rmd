...
visualize_ri(ri$questions_correct, ate_questions_correct, main = "RI of Questions Correct", xlab = "Treatment Effect")
#visualize_ri(ri$credibility,       ate_credibility)
#visualize_ri(ri$importance,        ate_importance)
visualize_ri(ri$time_read_article, ate_time_read_article, main = "RI of Article Read Time (seconds)", xlab = "Treatment Effect")
visualize_ri(ri$donation,          ate_donation, main = "RI of Donation in USD", xlab = "Treatment Effect")
```
...
```{r}
mod <- lm(questions_correct ~ treatment, data=f)
stargazer(mod, out = "subgroup_regression.html", type = "html")
```
