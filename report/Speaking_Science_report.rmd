...
We would like to believe that the observed results of our research are true; that people care more about articles if they have a personal stake in the ramifications presented in them, there are a few caveats worth mentioning about how generalizable our results are.

## Science Communication Field 

As discussed, the article that we chose focused on cargo ships and their effect on air pollution near the Port of Los Angeles. This is very much a niche topic in the world of science communications. As such, it can not be reasonably stated that the article represents the breadth of topics under the science communication umbrella. Journalistic scientific communication is published every day on topics of climate change, medicine, technology, space exploration, anthropology, and much more. Different science fields might benefit from different communication styles.
